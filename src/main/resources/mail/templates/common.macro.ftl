...
font-size: 16px; -moz-box-sizing: border-box; -webkit-box-sizing: border-box; box-sizing: border-box; color: #000000; margin: 0; padding: 0; border-width: 0;"
        bgcolor="#ffffff">
                            ...
                            <tr>
                              <td style="line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 20px;"
                                ...
                                <h1 class="h5 text-secondary"
                                    ...
                                    align="left">
                                  Witaj <span class="text-dark fw-700"
                                              style="color: #1a202c; font-weight: 700 !important;">${messageResponder}</span>!
                                </h1>
