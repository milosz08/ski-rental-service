...
<@m.commonWrapper>
  <p class="lh-sm" style="line-height: 1.25; font-size: 16px; width: 100%; margin: 0;" align="left">
    Właśnie złożyłeś(aś) nowy zwrot do systemu od wypożyczenia <strong>${rentIdentifier}</strong>. Poniżesz znajdziesz
    ponownie przeliczone stawki wypożyczonych sprzętów na podstawie daty stworzonego dokumentu zwrotu o numerze
    <strong>${returnIdentifier}</strong>.
  </p>
  ...
  <p class="lh-sm" style="line-height: 1.25; font-size: 16px; width: 100%; margin: 0;" align="left">
    Wszystkie zwroty oraz ich edycję możesz znaleźć
    <a href="${baseServletPath}/seller/returns" style="color: #0d6efd;"><u>pod tym adresem</u></a>.
  </p>
</@m.commonWrapper>
