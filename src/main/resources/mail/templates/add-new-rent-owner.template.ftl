...
<@m.commonWrapper>
  <p class="lh-sm" style="line-height: 1.25; font-size: 16px; width: 100%; margin: 0;" align="left">
    Pracownik ${employerFullName} właśnie złożył nowe wypożyczenie. Poniżej znajdziesz szczegóły złożonego przez
    pracownika wypożyczenia o numerze <strong>${rentIdentifier}</strong>.
  </p>
