...
public class ReturnDao implements IReturnDao {
    ...
    @Override
    public List<OwnerRentReturnRecordResDto> findAllPageableReturnsRecords(
    ...
    @Override
    public List<SellerRentReturnRecordResDto> findAllPageableReturnsFromEmployerRecords(
