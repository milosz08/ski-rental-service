...
<jsp:useBean id="addEditEquipmentData" class="pl.polsl.skirentalservice.dto.equipment.AddEditEquipmentResDto"
             scope="request"/>
<jsp:useBean id="equipmentBrandsModalData" class="pl.polsl.skirentalservice.dto.attribute.AttributeModalResDto"
             scope="request"/>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body px-0 pb-0">
        <c:if test="${equipmentBrandsModalData.alert.active}">
          <div class="alert mx-3 ${equipmentBrandsModalData.alert.type.cssClass} alert-dismissible mb-3 fade show lh-sm"
               role="alert">
