...
<jsp:useBean id="addEditEquipmentData" class="pl.polsl.skirentalservice.dto.equipment.AddEditEquipmentResDto"
             scope="request"/>
<jsp:useBean id="equipmentTypeModalData" class="pl.polsl.skirentalservice.dto.attribute.AttributeModalResDto"
             scope="request"/>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body px-0 pb-0">
        <c:if test="${equipmentTypeModalData.alert.active}">
          <div class="alert mx-3 ${equipmentTypeModalData.alert.type.cssClass} alert-dismissible mb-3 fade show lh-sm"
               role="alert">
