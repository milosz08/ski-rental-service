  ...
  <div class="row">
    ...
    <nav class="col-md-4 d-flex justify-content-sm-end justify-content-center align-items-center px-0 mb-2">
      ...
      <ul class="pagination pagination-sm mb-0">
        ...
        <li class="page-item ${pagesData.prevPage.btsClass}">
          <a
            href="${pageContext.request.contextPath}?page=${pagesData.prevPage.pageNumber}&total=${pagesData.totalPerPage}"
        ...
        <li class="page-item ${pagesData.nextPage.btsClass}">
          <a
            href="${pageContext.request.contextPath}?page=${pagesData.nextPage.pageNumber}&total=${pagesData.totalPerPage}"
            class="page-link px-1">
