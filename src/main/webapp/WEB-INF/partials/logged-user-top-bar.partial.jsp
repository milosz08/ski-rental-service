...
<header class="d-flex navbar bg-white sticky-top bg-white">
  ...
  <div class="dropdown dropdown-menu-end">
    <button class="d-flex align-items-center border-0 text-dark bg-transparent dropdown-toggle me-4"
      ...
      <img src="${pageContext.request.contextPath}/static/images/default-profile-image.svg" alt="" width="32"
    ...
    <ul class="dropdown-menu dropdown-menu-end text-small">
      ...
      <li>
        <hr class="d-block d-sm-none dropdown-divider">
      </li>
      ...
      <c:if test="${loggedUserDetails.roleEng.equals('owner')}">
