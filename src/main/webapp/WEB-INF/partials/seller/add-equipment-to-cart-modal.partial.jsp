...
<div class="modal fade eq-modals" id="addEquipment${cartEqAdd.id}" tabindex="-1" aria-hidden="true"
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <form action="${pageContext.request.contextPath}/seller/add-equipment-to-cart" method="post" class="px-2"
            novalidate>
        ...
        <div class="modal-body px-0 pb-0">
          <c:if test="${addModalResDto.alert.active}">
            <div class="alert mx-3 ${addModalResDto.alert.type.cssClass} alert-dismissible mb-3 fade show lh-sm"
                 role="alert">
