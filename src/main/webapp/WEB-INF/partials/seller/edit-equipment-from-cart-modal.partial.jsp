...
<div class="modal fade eq-modals" id="editEquipment${cartEq.id}" tabindex="-1" aria-hidden="true" data-bs-backdrop="static"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="${pageContext.request.contextPath}/seller/edit-equipment-from-cart" method="post" class="px-2" novalidate>
                <div class="modal-header">
                    <h1 class="modal-title fs-5">Edytuj sprzęt obecny w zestawieniu</h1>
                </div>
                <div class="modal-body px-0 pb-0">
                    <c:if test="${cartEq.resDto.alert.active}">
                        <div class="alert mx-3 ${cartEq.resDto.alert.type.cssClass} alert-dismissible mb-3 fade show lh-sm" role="alert">
