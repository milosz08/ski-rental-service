...
<td class="nowrap-tb align-middle">
    <fmt:formatNumber value="${inmemoryNewRentData.priceUnits.totalDepositPriceNetto}" minFractionDigits="2" type="currency"/>
</td>
<td class="nowrap-tb align-middle">
    <fmt:formatNumber value="${inmemoryNewRentData.priceUnits.totalDepositPriceBrutto}" minFractionDigits="2" type="currency"/>
</td>
