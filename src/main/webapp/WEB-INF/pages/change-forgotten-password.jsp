...
<jsp:useBean id="changePassData" class="pl.polsl.skirentalservice.dto.change_password.ChangeForgottenPasswordResDto"
             scope="request"/>
<jsp:useBean id="employerData" class="pl.polsl.skirentalservice.dto.change_password.ChangePasswordEmployerDetailsDto"
             scope="request"/>
