...
<jsp:useBean id="equipmentsData" type="java.util.List<pl.polsl.skirentalservice.dto.rent.EquipmentRentRecordResDto>" scope="request"/>
...
<p:generic-seller.wrapper>
    ...
    <c:if test="${not empty inmemoryNewRentData.equipments}">
        ...
        <c:forEach items="${inmemoryNewRentData.equipments}" var="cartEq">
            ...
            <div class="modal fade" id="deleteEquipment${cartEq.id}" data-bs-backdrop="static" tabindex="-1" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-body lh-sm">
