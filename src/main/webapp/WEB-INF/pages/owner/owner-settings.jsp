...
<jsp:useBean id="addEditOwnerData" class="pl.polsl.skirentalservice.dto.employer.AddEditEmployerResDto" scope="request"/>
...
<p:generic-owner.wrapper>
    ...
    <form action="" class="container-fluid px-0" method="post" novalidate>
                ...
                <fieldset class="border rounded-1 py-2 pb-0 px-3 pt-1 mb-3">
                    ...
                    <div class="row mt-0">
                        ...
                        <div class="col-xl-6 col-xl-2 mb-3">
                            ...
                            <input type="date" class="form-control form-control-sm ${addEditOwnerData.bornDate.errorStyle} onlyPreTimeSelect"
                        ...
                        <div class="col-xl-6 col-xl-2 mb-3">
                            ...
                            <input type="date" class="form-control form-control-sm ${addEditOwnerData.hiredDate.errorStyle} onlyPreTimeSelect"
                    ...
                    <div class="row mt-0">
                        ...
                        <div class="col-xl-6 mb-3">
                            ...
                            <input type="text" class="form-control form-control-sm ${addEditOwnerData.buildingNr.errorStyle}"
                                id="buildingNr" value="${addEditOwnerData.buildingNr.value}" name="buildingNr" placeholder="np. 43c"
                                maxlength="5">
                        ...
                        <div class="col-xl-6 mb-3">
                            ...
                            <input type="text" class="form-control form-control-sm ${addEditOwnerData.apartmentNr.errorStyle}"
                                id="apartmentNr" value="${addEditOwnerData.apartmentNr.value}" name="apartmentNr" placeholder="np. 12"
                                maxlength="5">
                        ...
                        <div class="col-xl-6 mb-3">
                            ...
                            <input type="text" class="form-control form-control-sm ${addEditOwnerData.postalCode.errorStyle}"
                                id="postCode" value="${addEditOwnerData.postalCode.value}" name="postalCode" placeholder="np. 43-100"
                                maxlength="70">
        ...
        <div class="hstack gap-3 justify-content-end">
            <button class="btn btn-sm btn-outline-danger" type="button" data-bs-toggle="modal" data-bs-target="#rejectChanges">
