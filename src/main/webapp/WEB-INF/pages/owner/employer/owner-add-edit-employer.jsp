...
<p:generic-owner.wrapper>
    ...
    <c:if test="${addEditText.equals('Dodaj')}">
        <div class="alert alert-primary" role="alert">
            ...
            Tworzona jest również skrzynka pocztowa pracownika z domeną <strong>@ski.miloszgilga.pl</strong>, do której
            hasło jest takie same jak do konta. Do takiego stworzonego konta przychodzi wiadomość email z hasłem
            wygenerowanym przez system, które pracownik może zmienić.
        </div>
    </c:if>
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        <label for="apartmentNr" class="form-label mb-1 text-secondary">Nr mieszkania:</label>
